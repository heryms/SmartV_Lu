...
ckCoordinate::ckCoordinate(void)
{
}
...
int ckCoordinate::LongLat2XY(double longitude,double latitude,double &X,double &Y)
{	
...
int ckCoordinate::XY2LongLat(double X,double Y,double& longitude,double& latitude)
{
...
*/
/************************************************************************/
int ckCoordinate::WorldtoMap(OriginPt org,double xIn,double yIn,double &xOut,double &yOut)
{
...
//转换局部坐标到全局世界坐标
int ckCoordinate::MaptoWorld(OriginPt org,double xIn,double yIn,double &xOut,double &yOut)
{
	double dx=0,dy=0,dstX=0,dstY=0;
